...
public class CommentTests
{
    ...
    public async Task CreateComment_WhenCommentIsEmpty_ShouldReturnError()
    {
        ...
        string title = "Title Test";
        string contentPost = "contentPost";

        Post post = new Post(title, contentPost, author);

        //Act
        string contentComment = "";
        Action act = () => new Comment(post, author, contentComment);

        //Assert
        act.Should()
           .Throw<ValueCannotBeEmptyException>()
